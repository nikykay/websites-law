...
class Blog_Info extends \Elementor\Widget_Base {
    /**
     * Get widget name.
     *
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section( 'blog_info', [
            'label' => __( 'Blog Info', 'default' ),
...
//        $custom_setting = $settings['setting_name'];
        ...
        ?>
                <div class="custom-widget our-blog-slider">
                        ...
                        ?>
                            ...
                            <div class="cont">
                                ...
                                <div class="content-box">
                                    ...
                                    <p class="blog-date">MAR 11 2020</p>
                                </div>
                            </div>
